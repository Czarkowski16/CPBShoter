...
if chosen_character == "Czarkowski":
    player_img = pygame.image.load('czarkowski.png')
elif chosen_character == "PanPole":
    player_img = pygame.image.load('panpole.png')
elif chosen_character == "Bober":
    player_img = pygame.image.load('bober.png')
...
enemy_width = 200
enemy_height = 200
enemy_img = pygame.image.load('Menel.png')
